...
define gui.accent_color = '#88c070'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#346856'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#e0f8d0'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#e0f8d0'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#e0f8d0'
...
## 用。
define gui.muted_color = '#346856'
define gui.hover_muted_color = '#88c070'

## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#e0f8d0'
define gui.interface_text_color = '#e0f8d0'


## 字体和字体大小 #####################################################################

## 游戏内文本使用的字体。
define gui.text_font = "fonts/unifont.otf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/unifont.otf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/unifont.otf"
...
define gui.choice_button_text_hover_color = "#e0f8d0"
...
## 导航按钮左侧相对于屏幕左侧的位置。
define gui.navigation_xpos = 360

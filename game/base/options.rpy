...
define config.name = _("The Process Of Dreaming")
...
define gui.about = _p("""这个游戏深受 梦日记 影响....
...
目前梦里只有一楼和四楼是开放的,
因为大部分内容是在活动的最后4天事件里赶出来的(虽然项目是在1月18创建的),
我没有能力做出太多场景.
如果有什么最恼人, 应该就是未完成吧, 让你玩半成品真是不好意思.

此版本用于参加"言语肇始兽人视觉小说极限创作挑战赛#0"



由 Another Escape 团队开发,
一个人的团队

大部分文本的使用字体: GNU Unifont
...
define build.name = "the_process_of_dreaming"
...
define config.save_directory = "process_of_dreams-1768741628"
